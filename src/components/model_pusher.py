...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        """
        self.s3 = SimpleStorageService() # for WS S3 cooecntion 

        self.model_evaluation_artifact = model_evaluation_artifact # evaluated model 

        self.model_pusher_config = model_pusher_config  # S3 bucket name and file name 
