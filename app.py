...
''' Deployed the ML model using fast API online ( but locally )'''


from fastapi import FastAPI, Request

# middleware for OPRT mamapign ( lcoal and onlien server )
...
class DataForm:
    """
    the USER Input fro forPrediction 
    ...
    async def get_vehicle_data(self):
        ...
        """
        # if talkingtie execute nex tliens of code 
...
# HOME PAGE will contain the user form 
...
async def predictRouteClient(request: Request):
    ...
    try:
        ...
        value = model_predictor.predict(dataframe=vehicle_df)[0] #since we ned bianry label 
